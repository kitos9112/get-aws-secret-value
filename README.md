...
```bash
# Linux
curl -L https://github.com/kitos9112/get-aws-secret-value/releases/download/0.1.50/get-aws-secret-value_0.1.50_linux_x86_64.tar.gz | tar xz

# OS X
curl -L https://github.com/kitos9112/get-aws-secret-value/releases/download/0.1.50/get-aws-secret-value_0.1.50_osx_x86_64.tar.gz | tar xz

# Windows
curl -LO https://github.com/kitos9112/get-aws-secret-value/releases/download/0.1.50/get-aws-secret-value_0.1.50_windows_x86_64.zip
unzip get-aws-secret-value_0.1.50_windows_x86_64.zip
```
