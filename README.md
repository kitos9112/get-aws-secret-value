...
```bash
# Linux x86_64
curl -L https://github.com/kitos9112/get-aws-secret-value/releases/download/0.2.104/get-aws-secret-value_0.2.104_linux_x86_64.tar.gz | tar xz

# Linux arm64
curl -L https://github.com/kitos9112/get-aws-secret-value/releases/download/0.2.104/get-aws-secret-value_0.2.104_linux_arm64.tar.gz | tar xz

# OS X x86_64
curl -L https://github.com/kitos9112/get-aws-secret-value/releases/download/0.2.104/get-aws-secret-value_0.2.104_osx_x86_64.tar.gz | tar xz

# OS X arm64
curl -L https://github.com/kitos9112/get-aws-secret-value/releases/download/0.2.104/get-aws-secret-value_0.2.104_osx_arm64.tar.gz | tar xz

# Windows x86_64
curl -LO https://github.com/kitos9112/get-aws-secret-value/releases/download/0.2.104/get-aws-secret-value_0.2.104_windows_x86_64.zip
unzip get-aws-secret-value_0.2.104_windows_x86_64.zip
```
